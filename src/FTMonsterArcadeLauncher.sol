...
import {FTMonsterLastBuyerPot} from "./FTMonsterLastBuyerPot.sol";
import {FTMonsterPenaltyDraw} from "./FTMonsterPenaltyDraw.sol";
...
/// @title FTMonsterArcadeLauncher
/// @notice Bonding-curve launcher for the Oracle777 arcade version.
contract FTMonsterArcadeLauncher {
    ...
    uint256 public constant CURVE_CLOSE_GROSS_ETH = 17 ether;
    uint256 public constant CURVE_CLOSE_NET_ETH = 15_980_000_000_000_000_000;
    uint256 public constant API_FEE_BPS_EARLY = 200;
    uint256 public constant MAX_POST_WINDOW_API_FEE_BPS = 80;
    uint256 public constant DEFAULT_POST_WINDOW_API_FEE_BPS = 80;
    uint256 public constant JACKPOT_FEE_BPS = 100;
    uint256 public constant LP_CLUB_FEE_BPS = 100;
    uint256 public constant PENALTY_DRAW_FEE_BPS = 200;
    uint256 public constant BPS_DENOMINATOR = 10_000;
    uint256 public constant FIXED_API_WINDOW = 77 minutes;
    ...
    FTMonsterLastBuyerPot public jackpot;
    FTMonsterPenaltyDraw public penaltyDraw;
    ...
    function setJackpot(address jackpot_) external onlyOwner {
        ...
        jackpot = FTMonsterLastBuyerPot(payable(jackpot_));
    ...
    function setPenaltyDraw(address penaltyDraw_) external onlyOwner {
        ...
        penaltyDraw = FTMonsterPenaltyDraw(payable(penaltyDraw_));
